...
<jsp:useBean id="trabajo" scope="request" type="org.lab.demo2.beans.Job" />
<!DOCTYPE html>
<html>
<head>
...
<div class='container'>
    ...
    <form method="POST" action="<%=request.getContextPath()%>/JobServlet?action=crear" class="col-md-6 col-lg-6">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="jobTitle" name="jobTitle" value="<%=trabajo.getTitulo()%>">
        </div>
        <div class="mb-3">
            <label for="minSalary">Min Salary</label>
            <input type="text" class="form-control" id="minSalary" name="minSalary" value="<%=trabajo.getMins()%>">
        </div>
        <div class="mb-3">
            <label for="maxSalary">Max Salary</label>
            <input type="text" class="form-control" id="maxSalary" name="maxSalary" value="<%=trabajo.getMaxs()%>">
        </div>
